"""Scraper para o Oscar (Oscar App)."""
...
class OscarScraper(BaseScraper):
    """Scraper para o website do Oscar App."""

    COMPANY_ID = "oscar"
    COMPANY_NAME = "Oscar (Oscar App)"

    URLS = {
        "home": "https://oscarapp.pt",
        "services": "https://oscarapp.pt/servicos",
        "pricing": "https://oscarapp.pt/precos",
        "about": "https://oscarapp.pt/sobre",
        "locations": "https://oscarapp.pt/localizacoes",
    }

    def scrape(self) -> CompanySnapshot:
        """Scrape completo do website Oscar."""
        logger.info(f"[{self.COMPANY_ID}] Iniciando scraping do Oscar...")
        raw_pages = {}
        parsed_pages = {}
    ...
    def extract_services(self, soup: BeautifulSoup) -> list[str]:
        """Extrai serviços do Oscar."""
        services = []
        for selector in [
            ".service", ".servico", ".service-card", ".service-item",
            "[class*=service]", "[class*=servico]", ".card",
        ]:
    ...
    def extract_pricing(self, soup: BeautifulSoup) -> dict:
        """Extrai informação de preços do Oscar."""
        pricing = {}
